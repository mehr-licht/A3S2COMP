...
public class SymbolTable implements Cloneable {
  ...
  public Symbol getReturnSymbol() {
    if (this.returnSymbol != null) return this.returnSymbol;
    return null;
  }
  ...
  public Symbol getFromAll(String name) {
    ...
    if (this.returnSymbol != null
        && name.equals(this.returnSymbol.getName())
        && this.returnSymbol.getInit()) return this.returnSymbol;
    else if (this.variables.get(name) != null) return this.variables.get(name);
    else if (this.parameters.get(name) != null) return this.parameters.get(name);
    else return null;
  }
  ...
  public void setRegisters(String functionName) {
    ...
    if (functionName.equals("main")) registerCounter = 1;
